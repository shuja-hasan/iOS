...
class StringFormatterTest: XCTestCase {
    ...
    func testDecimalToStingFormatter() {
        ...
        XCTAssertEqual(stringFormatter.token(with: 10_000_000_000_000.1234, and: 0), "10000000000000")
        ...
        XCTAssertEqual(stringFormatter.token(with: 100_000_001.1234, and: 2), "100000001\(decimalSeparator)12")
