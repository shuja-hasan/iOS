...
//
//        let viewModel = TransactionViewModel(transaction: .make(blockNumber: blockNumber), config: .make(), currentAccount: .make(), server: .make())
//
...
//        chainState.latestBlock = blockNumber
//
//        let viewModel = TransactionViewModel(transaction: .make(blockNumber: 1), config: .make(), currentAccount: .make(), server: .make())
//
