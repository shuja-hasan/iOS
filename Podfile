...
target 'Trust' do
  ...
  pod 'BigInt', '~> 3.0'
  pod 'R.swift'
  pod 'JSONRPCKit', :git=> 'https://github.com/fxwx23/JSONRPCKit.git', :branch=>'xcode10-swift4.2'
  pod 'PromiseKit', '~> 6.0'
  pod 'APIKit'
  pod 'Eureka'
  pod 'MBProgressHUD'
  ...
  pod 'Kingfisher', '~> 4.0'
  pod 'TrustCore', :git=>'https://github.com/itsmylife44/trust-core', :branch=>'ether1'
  pod 'TrustKeystore', :git=>'https://github.com/itsmylife44/trust-keystore', :branch=>'ether1'
  pod 'TrezorCrypto'
  pod 'Branch'
  pod 'SAMKeychain'
